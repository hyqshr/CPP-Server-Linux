...
int main(int argc, char const *argv[])
{
    ...
    while(1)
    {
        ...
        if(pid == 0){
            ...
            printf("buffer message after parse: %s\n", buffer);
            ...
            if (isGetMethod(parse_string_method)){
                ...
                char *find_string = static_cast<char*>(malloc(200));
...
bool isGetMethod(const char* parse_string_method) {
    return strcmp(parse_string_method, "GET") == 0;
}
